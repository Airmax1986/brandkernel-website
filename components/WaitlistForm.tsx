...
"use client"; // Wichtig, da wir Hooks wie useState verwenden
...
export default function WaitlistForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (res.ok) {
      setEmail(""); // Eingabefeld bei Erfolg leeren
    }
  };

  return (
    // Positioniert die Leiste fixiert am unteren Rand des Bildschirms
